...
experiment, not a known fix - see the module docstring in scraper_embed.py
for how a failure here still surfaces a debug snapshot to check.
...
async def _ensure_browser() -> Browser:
    ...
    _browser = await AsyncNewBrowser(
        ...
        geoip=True,  # picks a locale/timezone/screen consistent with the exit IP
